                      ...
                      <div class="row">
                        <div class="col-7">
                          <div class="d-flex align-items-center">
                            ...
                            >
                              <use
                                xlink:href="{{ url('assets/static') }}/images/bootstrap-icons.svg#circle-fill"
                              />
                            </svg>
                          ...
                          <tbody>
                              ...
                              <td class="col-3">
                                <div class="d-flex align-items-center">
                                  <div class="avatar avatar-md">
                                    <img src="{{ url('assets/compiled') }}/jpg/5.jpg" />
                                  </div>
                            ...
                            <tr>
                              <td class="col-3">
                                <div class="d-flex align-items-center">
                                  <div class="avatar avatar-md">
                                    <img src="{{ url('assets/compiled') }}/jpg/2.jpg" />
                                  </div>
                ...
                <div class="card-body py-4 px-4">
                  <div class="d-flex align-items-center">
                    <div class="avatar avatar-xl">
                      <img src="{{ url('assets/compiled') }}/jpg/1.jpg" alt="Face 1" />
                    </div>
                    <div class="ms-3 name">
                ...
                <div class="card-content pb-4">
                  <div class="recent-message d-flex px-4 py-3">
                    <div class="avatar avatar-lg">
                      <img src="{{ url('assets/compiled') }}/jpg/4.jpg" />
                    </div>
                    <div class="name ms-4">
